...
ds_iter = {
    "train":enumerate(DataLoader(LRADataset(os.path.join(curr_path, f"datasets/{dataset_file}.train.pickle"), True), batch_size = training_config["batch_size"], drop_last = True)),
    "dev":enumerate(DataLoader(LRADataset(os.path.join(curr_path, f"datasets/{dataset_file}.dev.pickle"), True), batch_size = training_config["batch_size"], drop_last = True)),
    "test":enumerate(DataLoader(LRADataset(os.path.join(curr_path, f"datasets/{dataset_file}.test.pickle"), False), batch_size = training_config["batch_size"], drop_last = True)),
}
...
log_f_path = os.path.join(checkpoint_dir, f"{task}_output.log")
